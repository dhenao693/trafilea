...
import static co.com.trafilea.web.shapermint.userinterfaces.buy.UserInfoFormPage.BTN_PURCHASE;
import static co.com.trafilea.web.shapermint.userinterfaces.buy.UserInfoFormPage.LBL_CARD_MODAL;
import static co.com.trafilea.web.shapermint.userinterfaces.buy.UserInfoFormPage.LBL_CITY_MODAL;
import static co.com.trafilea.web.shapermint.userinterfaces.buy.UserInfoFormPage.LBL_COUNTRY_MODAL;
import static co.com.trafilea.web.shapermint.userinterfaces.buy.UserInfoFormPage.LBL_MONTH_MODAL;
import static co.com.trafilea.web.shapermint.userinterfaces.buy.UserInfoFormPage.LBL_NAME_MODAL;
import static co.com.trafilea.web.shapermint.userinterfaces.buy.UserInfoFormPage.LBL_YEAR_MODAL;
...
public class FillUserForm implements Interaction {
    ...
    public static FillUserForm toPay(List<Map<String, String>> userInfo) {
        UserInfo userInfoModel = ConvertMapToModel.convertMapToUserInfo(userInfo.get(0));
