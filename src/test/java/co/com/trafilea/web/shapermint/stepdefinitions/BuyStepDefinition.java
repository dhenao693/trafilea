...
import co.com.trafilea.web.shapermint.interactions.buy.FillUserFormWithout;
...
import co.com.trafilea.web.shapermint.tasks.AddToCard;
import co.com.trafilea.web.shapermint.tasks.SelectCar;
...
public class BuyStepDefinition {
    ...
    public void seeTheAlertWithMessage(String alertMessage) {
        theActorInTheSpotlight().should(GivenWhenThen.seeThat(SeeAlertText.inScreen(), equalTo(alertMessage)));
    }
